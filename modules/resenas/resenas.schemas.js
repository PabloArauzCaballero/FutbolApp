...
const createSchema = z.strictObject({
    ...
    calificacion: z.coerce.number().int("calificacion debe ser entero").min(1, "calificacion debe ser al menos 1").max(5, "calificacion debe ser máximo 5"),
    comentario: z.string().trim().min(1, "comentario es obligatorio"),
});

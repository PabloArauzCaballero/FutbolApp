    ...
    modules: [
        {
            ...
            formFields: [
                { name: 'nombre', label: 'Nombre', type: 'text', required: true, placeholder: 'Ej. Fútbol 7' },
            ],
        },
        {
            key: 'canchas',
        ...
        },
        {
            key: 'personas',
            title: 'Usuarios',
            description: 'Gestiona los usuarios del sistema. La creación usa el módulo de registro.',
            ...
            formFields: [
                ...
                { name: 'contrasena', label: 'Contraseña', type: 'password', required: true, onlyOnCreate: true },
                {
                    name: 'rol',
                    label: 'Rol',
                    type: 'select',
        ...
        },
        {
            ...
            formFields: [
                ...
                { name: 'calificacion', label: 'Calificación', type: 'number', required: true, min: '1', max: '5', step: '1' },
...
function getModuleConfigByKey(moduleKey) {
    return frontendConfig.modules.find((moduleConfig) => moduleConfig.key === moduleKey) || null;
}

function getNavigationItems() {
    return frontendConfig.modules.map((moduleConfig) => ({
